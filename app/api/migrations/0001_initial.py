# Generated by Django 4.0.1 on 2022-02-14 16:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numberOfExercises', models.IntegerField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=30)),
                ('numberOfEexercises', models.IntegerField()),
                ('totalTimeOfExercises', models.FloatField()),
                ('image', models.ImageField(default='None/no-img.jpg', upload_to='images/')),
                ('status', models.BooleanField(default=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('catogery', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.category')),
